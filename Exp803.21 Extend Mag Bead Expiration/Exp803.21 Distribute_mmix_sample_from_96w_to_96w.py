...
# metadata
metadata = {
    'protocolName': 'Distribute 15ul Mmix and 5ul Extracted MS2 Phage to 96w Plate.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Aliquoting SARS-CoV-2 mix to plate and then adding 5ul MS2 sample extraction from 96w DeepWell plate.',
    'apiLevel': '2.12'
}
