...
# metadata
metadata = {
    'protocolName': 'Compare Two MasterMixes, 18ul, Using 8 Standards',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Create a 4-rep pos control amplification in a 96w plate with 18ul from 2 mastermixes.',
    'apiLevel': '2.12'
}
##########################
# functions
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # mix_rack
    mmixOne = mix_rack['A1'] # 15*40*1.125 = 810µl
    mmixTwo = mix_rack['A6'] # 15*40*1.125 = 810µl
    # CALCS
    ...
    multiwell_mix = mix_per_well*reps*(1+overage) # 18*4*(1+0.125) = 81ul
    sample_per_well = 2
