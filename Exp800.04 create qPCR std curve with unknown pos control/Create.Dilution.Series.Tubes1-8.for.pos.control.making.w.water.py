...
# metadata
metadata = {
    'protocolName': 'Create Dilution Series for Tubes 1--8 for Positive Control Making.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Create a 8-tube pos control dilution series on a 24-well rack. 900ul water also added.',
    'apiLevel': '2.12'
}
##########################
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    #water_rack    
    water = water_rack['A1'] # 900*8 = 7200ul water, round up to 8mL.
    ...
    p300.pick_up_tip()
    waterH = fifteen_ml_heights(8000, 41, 180) # 180*5=900, 8*5 = 40 total steps +1 
