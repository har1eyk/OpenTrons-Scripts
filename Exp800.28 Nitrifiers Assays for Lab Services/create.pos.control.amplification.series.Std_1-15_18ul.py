...
# metadata
metadata = {
    'protocolName': 'Create Amplification Curve using Pos Control Dilution Series Stds_1-15with 18ul MasterMix',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # mix_rack
    water = mix_rack['D6'] # 1500ul water
    mmix = mix_rack['A1'] # 18*(96-16)*1.1 = 1584ul
