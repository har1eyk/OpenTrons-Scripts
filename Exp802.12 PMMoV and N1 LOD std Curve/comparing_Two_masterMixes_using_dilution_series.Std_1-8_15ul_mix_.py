...
def tip_heights(init_vol, steps, vol_dec):
    ...
    return heights
# tips high for 2mL Eppendorf tubes
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    stds_block = sectempdeck.load_labware('opentrons_24_aluminumblock_generic_2ml_screwcap')
    ...
    # REAGENTS 
    std_1 = stds_block['A1'] # diluted standard
    std_2 = stds_block['A2']
    std_3 = stds_block['A3']
    std_4 = stds_block['A4']
    std_5 = stds_block['A5']
    ...
    std_8 = stds_block['D2']
    std_9 = stds_block['D3']
    std_10 = stds_block['D4']
    std_11 = stds_block['D5']
    std_12 = stds_block['D6']
     
    # mix_rack
    mmixOne = stds_block['B1'] # 15*40*1.125 = 675µl
    mmixTwo = stds_block['C6'] # 15*40*1.125 = 675µl
    # CALCS
    ...
    std_wells = [std_1, std_2, std_3, std_4, std_5, std_6, std_7, std_8] # this can change to be lower range, too, but only 8 allowed.
    # std_wells = [std_5, std_6, std_7, std_8, std_9, std_10, std_11, std_12] # this can change to be lower range, too, but only 8 allowed.
    ...
    for mmix, wwell in zip(mixList, wellList): # iterate through mastermixes and well list per mix
        ...
        for wellLoc, h in zip(wwell, tip_heightsEpp(675, len(std_wells), multiwell_mix)): # iterate through wells and heights for each mix
