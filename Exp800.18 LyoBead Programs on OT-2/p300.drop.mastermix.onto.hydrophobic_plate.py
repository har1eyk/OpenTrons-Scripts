...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tempdeckTwo = protocol.load_module('tempdeck', '7') # have this so I don't have to move it off
    ...
    # hydroPlate = protocol.load_labware('noah_hydrophobic_thin_96_wellplate_200ul', '1')
    ...
    mmix = mixBlock['D1'] # if in 2mL tube, what position on aluminum block
    # mmix = rack['D1'] # if in 2mL tube, what position on aluminum block
    dispVol = 14.5
    mmixVol = 1531.2 # if in 2mL tube, how much mastermix volume. For 14.5ul in 96w plate = 14.5*96 = *1.15= 1600.8ul. runs out at 1.1 with last 4-w dispense
    ...
    mmixH = tip_heightsEpp(mmixVol, 3*8, dispVol*4) # each row goes to mix 3 times * 8 rows = 24 times
