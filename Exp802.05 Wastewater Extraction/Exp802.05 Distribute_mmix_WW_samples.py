...
# metadata
metadata = {
    'protocolName': 'Distribute Mmix and Wastewater Samples to 96wells.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Aliquoting SARS-CoV-2 mix to plate and then adding 5ul sample extraction from DeepWell plate.',
    'apiLevel': '2.11'
}
