...
# metadata
metadata = {
    'protocolName': 'Distribute Mmix and Wastewater Samples from 3 Col on 2 Deepwell to 96w Plate. 4 reps.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Aliquoting SARS-CoV-2 mix to PCR plate and adding 5ul sample extraction from 3 col on 2 deepwell plates after 18ul mix.',
    'apiLevel': '2.12'
}
