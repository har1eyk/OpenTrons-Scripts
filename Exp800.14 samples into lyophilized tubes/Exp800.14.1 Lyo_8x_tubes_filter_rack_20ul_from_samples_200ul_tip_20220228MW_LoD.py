...
def run(protocol: protocol_api.ProtocolContext):
    ...
    SAMP_1mix = stds_rack['D1'] # empty
    SAMP_2mix = stds_rack['D2'] # empty
    SAMP_3mix = stds_rack['D3'] # empty
    SAMP_4mix = stds_rack['D4'] # empty
    SAMP_5mix = stds_rack['D5'] # empty
    ...
    for i, mixtube in enumerate(SAMP_mixes):
        for y in range(0, len(holderList)):
            ...
            p300.aspirate(6*20*1.08, mixtube.bottom(2)) # 6*20*1.08 = 130
