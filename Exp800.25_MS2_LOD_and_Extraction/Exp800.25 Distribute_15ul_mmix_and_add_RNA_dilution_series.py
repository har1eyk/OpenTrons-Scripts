...
# metadata
metadata = {
    'protocolName': 'Distribute 15ul COVID-19 RT qPCR mmix and Add RNA Dilution Series.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Aliquoting COVID-19 to PCR plate and adding 5ul sample RNA.',
    'apiLevel': '2.12'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tube_rack = protocol.load_labware('vwr_24_tuberack_1500ul', '11')
    ...
    # REAGENTS   
    a_std_1 = alumBlock['A1']  # 980ul Water + 20ul 
    a_std_2 = alumBlock['A2']  # from previous program, 750ul
    a_std_3 = alumBlock['A3']  # from previous program, 750ul
    a_std_4 = alumBlock['A4']  # from previous program, 750ul
    a_std_5 = alumBlock['A5']  # from previous program, 750ul
    a_std_6 = alumBlock['A6']  # from previous program, 750ul
    a_std_7 = alumBlock['B1']  # from previous program, 750ul
    a_std_8 = alumBlock['B2']  # from previous program, 750ul
    a_std_9 = alumBlock['B3']  # from previous program, 750ul
    a_std_10 = alumBlock['B4']  # from previous program, 750ul
    a_std_11 = alumBlock['B5']  # from previous program, 750ul
    a_std_12 = alumBlock['B6']  # from previous program, 750ul
    a_std_13 = alumBlock['C1']  # from previous program, 750ul
    a_std_14 = alumBlock['C2']  # from previous program, 750ul
    a_std_15 = alumBlock['C3']  # from previous program, 750ul
    a_std_16 = alumBlock['C4']  # from previous program, 750ul
    a_std_17 = alumBlock['C5']  # from previous program, 750ul
    a_std_18 = alumBlock['C6']  # from previous program, 750ul
    
    
    
    LU_Mix = alumBlock['D1'] # LU MasterMix; must be in the same tubes as the a_stds, "2mL generic screw cap" 15*96*1.1ul = 1710ul
    # tube_rack
    neg = tube_rack['A1'] # Negative Control NFW 1000ul
    pos = tube_rack['D6'] # Positive Control 

    # LISTS
    rows = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H']
    # stds = [a_std_1, a_std_2, a_std_3, a_std_4, a_std_5, a_std_6,
            # a_std_7, a_std_8, a_std_9, a_std_10, a_std_11, a_std_12, a_std_13, a_std_14, neg, pos]
    stds = [a_std_5, a_std_6, a_std_7, a_std_8, a_std_9, a_std_10, a_std_11, a_std_12, a_std_13, a_std_14, a_std_15, a_std_16, a_std_17, a_std_18, neg, pos]
    ...
    # add 5ul of RNA dilution series to each well in 96w plate 
    j = 0   
    tubeHeight = tip_heightsEpp(750, 2, 15)
    posTubeHeight = tip_heights(100,2,15) # pos control tube rehydration vol
    negTubeHeight = tip_heights(1000,2,15) # neg control tube NFW vol
    
    for i, (std, row) in enumerate(zip(stds, 2*rows)):
        j = 6 if i > 7 else 0 # need a way to go from A1-->A7
        height = tubeHeight if i < 14 else negTubeHeight if i == 14 else posTubeHeight # need to accomodate diff tubes and volume levels
