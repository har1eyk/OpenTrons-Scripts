...
# metadata
metadata = {
    'protocolName': 'Distribute 15ul COVID-19 RT qPCR mmix and Add DNA from 15-tube Dilution Series.',
    'author': 'Harley King <harley.king@luminultra.com>',
    'description': 'Aliquoting COVID-19 to PCR plate and adding 5ul sample DNA. 6 replicates.',
    'apiLevel': '2.12'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tube_rack = protocol.load_labware('vwr_24_tuberack_1500ul', '1')
    series_rack = protocol.load_labware('vwr_24_tuberack_1500ul', '2')
    ...
    # series_rack
    a_std_1 = series_rack['A1']  # 980ul Water + 20ul 
    a_std_2 = series_rack['A2']  # from previous program, 750ul
    a_std_3 = series_rack['A3']  # from previous program, 750ul
    a_std_4 = series_rack['A4']  # from previous program, 750ul
    a_std_5 = series_rack['A5']  # from previous program, 750ul
    a_std_6 = series_rack['A6']  # from previous program, 750ul
    a_std_7 = series_rack['B1']  # from previous program, 750ul
    a_std_8 = series_rack['B2']  # from previous program, 750ul
    a_std_9 = series_rack['B3']  # from previous program, 750ul
    a_std_10 = series_rack['B4']  # from previous program, 750ul
    a_std_11 = series_rack['B5']  # from previous program, 750ul
    a_std_12 = series_rack['B6']  # from previous program, 750ul
    a_std_13 = series_rack['C1']  # from previous program, 750ul
    a_std_14 = series_rack['C2']  # from previous program, 750ul
    a_std_15 = series_rack['C3']  # from previous program, 750ul
    
    # tube_rack
    LU_Mix = tube_rack['A1'] # LU MasterMix; must be in the same tubes as the a_stds, "2mL generic screw cap" 15*96*1.1ul = 1710ul
    neg = tube_rack['D1'] # Negative Control NFW 1000ul
    ...
    # add 5ul of DNA dilution series to each well in 96w plate 
    j = 0   
